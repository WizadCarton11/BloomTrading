...
from custom_exceptions import ValidationError, CustomException, ParameterError
...
def test_dot_product_invalid_type():
    ...
    with pytest.raises(TypeCheckError, match=r'argument "matrix_1" \(list\) is not an instance of numpy.ndarray'):
